...
$(document).ready(function () {
    ...
    $(".slick-control").on("click", function () {
        if (xpaused) {
            $(".main_slick ul").slick("play");
            $(this).text("정지");
        } else {
            $(".main_slick ul").slick("pause");
            $(this).text("시작");
        }
        xpaused = !xpaused;
        $(this).toggleClass("paused");
...
$(document).ready(function () {
        ...
        //청사안내_상징물
    $('.Information_thumb .img01').click(function(){
        $(this).addClass('active');
        $('.view_larger.img01').addClass('active');
        $('.view_larger.img02').removeClass('active');
    });
    $('.Information_thumb .img02').click(function(){
        $(this).addClass('active');
        $('.view_larger.img02').addClass('active');
        $('.view_larger.img01').removeClass('active');
    });
